...
<body>
	...
	<form action="bupdate.do" method="post" enctype="multipart/form-data">
		<input type="hidden" name="bid" value="${ board.bid }"> <input
			type="hidden" name="original_filename"
			value="${ board.original_filename }"> <input type="hidden"
			name="rename_filename" value="${ board.rename_filename }"> <input
			...
			<tr>
				...
				<td>
					<!-- 첨부파일이 있는데 삭제하는 경우 --> <c:if
						test="${ !empty board.original_filename }">
