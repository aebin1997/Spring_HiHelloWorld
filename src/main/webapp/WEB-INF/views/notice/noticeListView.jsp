...
<body>
	...
	<br>
	<c:if
		test="${ !empty sessionScope.loginUser and sessionScope.loginUser.id eq 'admin123' }">
	...
	<center>
		...
		<div id="dateDiv">
			<form action="nsearchDate.do" method="post">
				<label>검색할 날짜를 입력하시오 : <input type="date" name="begin">
	...
	<div style="align: center; padding-left: 400px">
		...
		<button onclick="javascript:location.href='${ nlist }';">전체
			목록 보기</button>
	</div>
	<br>
	<table align="center" width="500" border="1" cellspacing="0"
		...
		<c:forEach items="${ requestScope.list}" var="n">
			<tr>
				...
				<td align="center"><c:if test="${!empty n.file_path }">◎</c:if>
					<c:if test="${empty n.file_path }">&nbsp;</c:if></td>
				<td align="center"><fmt:formatDate value="${n.n_create_date}"
