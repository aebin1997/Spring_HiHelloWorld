...
<meta name="description" content="지식iN에서 나의 활동을 한눈에 모아서 보세요!"/>
<meta name="viewport" content="width=1024">
<meta name="msapplication-config" content="none" />
<link rel="stylesheet" type="text/css" href="https://ssl.pstatic.net/static.kin/static/pc/20210209151259/css/min/common.css" />
<link rel="stylesheet" type="text/css" href="https://ssl.pstatic.net/static.kin/static/pc/20210209151259/css/min/components.css" />


	
	
		<link rel="stylesheet" type="text/css" href="https://ssl.pstatic.net/static.kin/static/pc/20210209151259/css/min/other.css">
...
<meta property="og:title" content="기본정보,프로필 : 네이버 지식iN"/>


	<meta property="og:url" content="https://kin.naver.com/myinfo/namecardProfileForm.nhn"/>



	<meta property="og:image" content="https://ssl.pstatic.net/static/kin/common/kin_thumbnail_new_w1000.png"/>

<meta property="og:description" content="지식iN에서 나의 활동을 한눈에 모아서 보세요!"/>
<meta property="og:article:author" content="네이버 지식iN"/>
...
nhn.jsDir = 'https://ssl.pstatic.net/static.kin/static/pc/20210209151259/js/min';
...
<div class="skip_nav header_gnb_inner">
	...
	<a href="#content" onclick="nhn.Kin.Utility.skipNavigation('content');return false;" class="skip">본문 바로가기</a>
...
<div id="ieUpdateBanner" role="dialog" aria-labelledby="ieUpdateBannerTitle" class="popup popup--header_notice" style="display: none;">
	<h1 id="ieUpdateBannerTitle" tabindex="0" class="blind">권장 브라우저 업데이트 안내</h1>
	<div class="popup__content">
		...
		<div class="popup__maintext">
			...
			<p class="popup__subtext">새롭게 바뀐 지식iN Q&amp;A 페이지는 IE 9.0 이상의 브라우저에 최적화되어 있습니다. 원활한 이용을 위해 꼭 업데이트 해주세요! <a href="https://support.microsoft.com/ko-kr/help/17621/internet-explorer-downloads" class="popup__link" target="_blank">업데이트하기 <span class="sp_common ico_arr_lnk"></span></a></p>
		</div>
		...
		<div class="header_gnb_inner">
			<div class="header_gnb__cell">
				...
				<div class="header_search">
					...
					<form name="topSearch" id="topSearch" method="get" action="/search/list.nhn" onSubmit="return checkQuery();">
						<fieldset>
							...
							<div class="search_area">
								...
								<div>
									<iframe id="autoFrame" class="auto_complete_box" title="검색어 자동완성" frameborder="0" width="290" height="193px" marginwidth="0" marginheight="0" scrolling="no"></iframe>
								</div>
			...
			<div class="header_gnb__cell">
				<div class="gnb_wrap">
					<div class="gnb_eXpertLogo">
						...
						<div class="banner" id="bannerExpert" aria-labelledby="bannerLink" style="display:none">
							<div class="inner">
								<p>전문가 상담이 필요할 땐,<br><strong>지식iN 엑스퍼트!</strong></p>
					...
					<div class="gnb_common_area">
						<div id="gnb">
							...
							<script type="text/javascript" charset="utf-8" src="https://ssl.pstatic.net/static.gn/templates/gnb_utf8.nhn?2021021916"></script>
						</div>
					</div>
					...
					<div class="header__rolling rolling-notice">
						...
						<ul id="listNotice" class="rolling-notice__list _rolling_banner">
								...
								<li class="rolling-notice__item _rollingItem" data-start-time="2021-01-15 00:00:00" style="display:none;">
								...
								<li class="rolling-notice__item _rollingItem" data-start-time="2021-01-15 00:00:00" style="display:none;">
									<a href="https://expert.naver.com/expert/introduction?tab=guide" class="rolling-notice__link" onclick="nhn.Kin.Utility.nClicks('STA.event', '', '', event);">
										<i class="icon_new_red _newMark" style="display:none;"><span class="blind">새소식</span></i>
											<span class="text-color--secondary">MBTI/정리수납 전문가 모집중</span>
									</a>
								</li>
							
								<li class="rolling-notice__item _rollingItem" data-start-time="2021-01-15 00:00:00" style="display:none;">
									<a href="https://m.kin.naver.com/mobile/events/20945795026" class="rolling-notice__link" onclick="nhn.Kin.Utility.nClicks('STA.event', '', '', event);">
										<i class="icon_new_red _newMark" style="display:none;"><span class="blind">새소식</span></i>
											각 분야 최고 전문가의 클래스
									</a>
								</li>
		...
		<div class="nav_inner">
			...
			<ul class="nav_list" id="au_lnb" role="menubar">
				<li class="menu" role="presentation">
					<a href="/index.nhn" role="menuitem" class="item" id="au_lnb_home" tabindex="0" onClick="nhn.Kin.Utility.nClicks('LNB.home', '', '', event);"><em>홈</em></a>
				</li>
				<li class="menu" role="presentation">
					
					<a href="/qna/list.nhn" role="menuitem" class="item" aria-haspopup="true" aria-expanded="false" tabindex = "-1" onClick="nhn.Kin.Utility.nClicks('LNB.qna', '', '', event);"><em>Q&amp;A</em></a>
					<ul class="nav_sub_list _lnbSubMenu" role="menu">
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=11" role="menuitem" class="item" tabindex="-1"  onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '11', '1', event);">교육, 학문</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=1" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '1', '2', event);">컴퓨터통신</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=2" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '2', '3', event);">게임</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=3" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '3', '4', event);">엔터테인먼트, 예술</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=8" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '8', '5', event);">생활</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=7" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '7', '6', event);">건강</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=6" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '6', '7', event);">사회, 정치</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=4" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '4', '8', event);">경제</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=9" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '9', '9', event);">여행</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=10" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '10', '10', event);">스포츠, 레저</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=5" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.kinlayer', '5', '11', event);">쇼핑</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=13" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.jun', '', '', event);">쥬니버Q&amp;A</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=12" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.loc', '', '', event);">지역&amp;플레이스</a></li>
						<li role="presentation" class="sub_menu"><a href="/qna/list.nhn?dirId=20" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.talk', '', '', event);">고민Q&amp;A</a></li>
						<li role="presentation" class="sub_menu"><a href="/opendic/index.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.open', '', '', event);">오픈사전</a></li>
					</ul>
				</li>
				<li class="menu" role="presentation">
					<a href="/qna/questionList.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.answer', '', '', event);"><em>답변하기</em></a>
				</li>
				<li class="menu" role="presentation">
					<a href="/volunteer/index.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.donation', '', '', event);"><em>지식기부</em></a>
				</li>
				<li class="menu" role="presentation">
					<a href="/people/elite/index.nhn?from=lnb" role="menuitem" tabindex="-1" class="item" id="peopleLnbBtn" onClick="nhn.Kin.Utility.nClicks('LNB.people', '', '', event);"><em>사람들</em></a>
				</li>
				<li class="menu" role="presentation">
					<a href="/best/listaha.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.best', '', '', event);"><em>베스트</em></a>
				</li>
				<li class="menu" role="presentation">
					<a href="/hall/index.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.honor', '', '', event);"><em>명예의전당</em></a>
				</li>
				<li class="menu" role="presentation">
					<span class="lnb_bar">|</span>
					<a href="/myinfo/index.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.profile', '', '', event);"><em>프로필</em></a>
				</li>
				<li class="menu" role="presentation">
					<a href="/partnercenter/index.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.partner', '', '', event);"><em>파트너센터</em></a>
				</li>
				
					<li class="menu" role="presentation">
						<a href="/roulette/home.nhn" role="menuitem" class="item" tabindex="-1" onClick="nhn.Kin.Utility.nClicks('LNB.roulette', '', '', event);"><em>룰렛</em></a>
					</li>
					...
					<a href="#" class="nav__button_question _clickcode:LNB.q" onClick="nhn.Kin.checkRosAndGoUrl(event, '/qna/question.nhn', '');" role="button"><span
							class="btn_inner"><i class="sp_gnb icon_pencil"></i>질문하기</span></a>
...
<h2 class="blind">프로필</h2>
	...
	<div class="my_personal_inner my_personal_simple">
		<div class="profile_section _profile_section">
			<div class="profile_info">
				...
				<div class="profile_name">
					<a href="/profile/index.nhn?u=zOV4oFmwEys3po3XG%2BgJdGTdu4dmANq2rfx0u5sKVec%3D">
				...
				<div class="btn_info">
						...
						<a href="/myinfo/namecardProfileForm.nhn" onclick="nhn.Kin.Utility.nClicks('prf.infoedit', '', '', event);"><img
								src="https://ssl.pstatic.net/static/kin/09renewal/btn_info_edit.gif" width="61" height="18" alt="정보관리"></a>
				...
				<div class="my_main no_my_main">
					<div class="tit _tit">
						...
						<div class="layer_base layer_balloon" style="width: 269px; top: 15px; left: -67px; display:none;" id="au_layer_help">
							...
							<p>주요활동분야는 <em>채택답변이 5개 이상 있는 2단계 이하<br>디렉토리 중에서</em> 최대 4개까지 선택할 수 있습니다.<br>자신을 대표할 수 있는 주로 답변하는 디렉토리로<br>설정해주세요.</p><a
								class="close _lookUpChildElement('img')" href="#"><img alt="닫기"
																					   src="https://ssl.pstatic.net/static/kin/09renewal/btn_close_layer.gif"
																					   width="19" height="19" class="_close"></a>
		...
		<div class="profile_section3">
			<dl class="my_spec">
				<dt>등급</dt>
				<dd>
					<strong class="grade4">초수</strong>
					(내공 <strong>1,983</strong>)
				</dd> <!-- 등급에 따라 strong의 class가 변경됩니다. grade1~15 -->
				<dt>답변</dt>
				<dd>
					<strong>8</strong> (채택답변
					3<span class="bar">|</span>답변채택률
					75%)
				</dd>
				<dt>질문</dt>
				<dd>
					<strong>55</strong> (채택질문
					31<span class="bar">|</span>질문채택률
					67.4%)
				</dd>
			</dl>
		</div>
	...
	<br>
	<script type="text/javascript" src="https://ssl.pstatic.net/static.kin/static/pc/20210209151259/js/min/nhn.Kin.Userinfo.MainProfileBox.js"></script>
...
<div class="snb snb_bordered snb_mykin">
	...
	<ul class="snb_list">
		...
		<li >
			<a href="/myinfo/answerList.nhn" class="" id="subMenuOfMykin">나의 답변 <span class="num">(8)</span></a>
			
			
		</li>
		<li ><a href="/myinfo/questionList.nhn">나의 질문 <span class="num">(55)</span></a></li>
		<li ><a href="/myinfo/userFriendList.nhn">나의 친구 <span class="num">(0)</span></a></li>
		<li ><a href="/myinfo/gift/point/history.nhn">포인트로 감사 내역<em class="new"><span class="blind">NEW</span></em></a></li>
		<li ><a href="/myinfo/opendicList.nhn">나의 오픈사전 <span class="num">(0)</span></a></li>
		
			<li ><a href="/myinfo/happybeanListAccumulation.nhn">해피빈 기부함</a></li>
		
		<li class="">
			<a href="/myinfo/directQuestionList.nhn">1:1질문</a>
			<ul class="sub">
				<li ><a href="/myinfo/directQuestionList.nhn">받은 질문 <span class="num">(0)</span></a></li>
				<li ><a href="/myinfo/directQuestionSendList.nhn">보낸 질문 <span class="num">(6)</span></a></li>
			</ul>
		</li>
		<li ><a href="/myinfo/likeList.nhn">나의 표정/궁금/보관지식</a></li>
		<li ><a href="/myinfo/interest.nhn">나의 관심질문</a></li>
		<li ><a href="/myinfo/deletedArticleList.nhn">나의 삭제 지식 <span class="num">(0)</span></a></li>
		<li class="is_active">
			<a href="/myinfo/namecardProfileForm.nhn">관리</a>
			<ul class="sub">
				<li class="is_active"><a href="/myinfo/namecardProfileForm.nhn">기본정보</a></li>
				<li ><a href="/myinfo/tempsaveList.nhn">임시저장 <span class="num">(7)</span></a></li>
				<li ><a href="/myinfo/pointHistory.nhn" onclick="nhn.Kin.Utility.nClicks('edt*point', '', '', event);">내공</a></li>
			</ul>
		</li>
	</ul>
</div>
...
<div class="sp_common_tab myinfo_tab">
	<ul>
		...
		<li><a href="/myinfo/licenseSettingForm.nhn" onclick="nhn.Kin.Utility.nClicks('.license', '', '', event);">취득 자격 관리</a></li>
		<li><a href="/myinfo/notifySettingForm.nhn" onclick="nhn.Kin.Utility.nClicks('.alarm', '', '', event);">서비스 설정</a></li>
	</ul>
</div>
...
<form name="f" action="namecardProfileAction.nhn" method="post">
...
<fieldset>
	...
	<table class="tb_myinfo" cellpadding="0" cellspacing="0" summary="프로필 관리" id="au_my_intro" role="presentation">
			...
			<td role="presentation">
				<ul class="set_name">
					<li>
						...
						<input type="radio" class="input_chk" id="set_nick1" name="useNickname" value="false">
						<label for="set_nick1">별명 사용 안함</label>
					</li>
					<li>
						<input type="radio" class="input_chk" id="set_nick2" name="useNickname" value="true" checked>
						<label for="set_nick2">별명 사용</label><span class="name_desc2">답변할 때 별명과 아이디가 함께 표시됩니다. 예) 지식도령 (gil_dong_hong)</span>
					</li>
				</ul>
				<div class="nick">
					
						<input type="text" value="빠라삐융" name="nickname" id="nickname" class="input_text _input_nickname" style="width:229px;"   title="별명 입력" aria-disabled="false" >
		...
		<tr role="presentation">
			...
			<td role="presentation">
				...
				<ul class="set_photo _set_photo" id="photo"  id="cropPhoto" style="display:none">
					<li>
						<p class="thumb">
		...
		<tr role="presentation">
			...
			<td role="presentation">
					...
					<ul class="introduce_info_area">
						...
						<li class="introduce_info">자격증 정보는 취득자격관리에서 등록해주세요! <a class="introduce_reg_link" href="/myinfo/licenseSettingForm.nhn">등록하기 &gt;</a></li>
					</ul>
	...
	<table class="tb_myinfo" cellpadding="0" cellspacing="0" summary="프로필 만들기" id="au_my_intro2" role="presentation">
		<tr role="presentation">
			...
			<td role="presentation" id="au_major_url">
						...
						<div class="input_mb" style="z-index:90">
							<input type="text" name="urlDesc" id="urlDesc0" class="input_text _input_text" maxlength="8" style="width:130px;" value="업체명(스마트플레이스)"
								   title="업체명(스마트플레이스)"> :
							<input type="text" name="url" id="url0" class="input_text2 _input_url"  style="width:413px;" value="http://"
								   title="업체(스마트플레이스) URL">
							<!-- url 형식 체크 레이어 -->
						...
						<div class="input_mb" style="z-index:80">
							<input type="text" name="urlDesc" id="urlDesc1" class="input_text _input_text" maxlength="8" style="width:130px;" value="블로그 또는 카페"
								   title="블로그명 또는 카페명"> :
							<input type="text" name="url" id="url1" class="input_text2 _input_url"  style="width:413px;" value="http://"
								   title="블로그 또는 카페 URL 입력">
							<!-- url 형식 체크 레이어 -->
						...
						<div class="input_mb" style="z-index:70">
							<input type="text" name="urlDesc" id="urlDesc2" class="input_text _input_text" maxlength="8" style="width:130px;" value="서비스명"
								   title="서비스명"> :
							<input type="text" name="url" id="url2" class="input_text2 _input_url"  style="width:413px;" value="http://"
								   title="서비스 URL">
							<!-- url 형식 체크 레이어 -->
		...
		<p class="agree_info_text">입력하신 별명, 사진, 소속(근무처), 직업, 주요경력은 지식iN 서비스내 프로필 공개를 목적으로 하며, <br>언제든지 직접 삭제할 수 있고, 탈퇴 시에는 바로 파기됩니다.</p>
		<div class="agree_box">
...
<script type="text/template" id="delegate_answer_list_tpl">
	{if result.length > 0}
		<p class="paragraph3">현재 설정된 대표답변 : {=result.length}건 <a href="#" onclick="nhn.Kin.Utility.popup('/popup/delegateAnswers.nhn', 'expertiseCancelAnswer', \{width:720,height:750\});return false;" target="_blank" class="set_ans2"><img src="https://ssl.pstatic.net/static/kin/09renewal/btn_set_ans.gif" width="78" height="22" alt="대표답변 설정"></a></p>
		<ul class="represent_anwser" id="au_represent_anwser">
		{for answer in result}
			<li>
		 		<div class="sel"><a href="/qna/detail.nhn?d1id={=answer.d1Id}&dirId={=answer.dirId}&docId={=answer.docId}" target="_blank">{=answer.title}</a></div>
				<span class="cate"><a href="/qna/list.nhn?dirId={=answer.dirId}" target="_blank">{=answer.dirName}</a></span>
			</li>
		{/for}
		</ul>
	...
	{else}
		...
		<a href="#" onclick="nhn.Kin.Utility.popup('/popup/delegateAnswers.nhn', 'expertiseCancelAnswer', \{width:720,height:750\});return false;" target="_blank" class="set_ans"><img src="https://ssl.pstatic.net/static/kin/09renewal/btn_set_ans.gif" width="78" height="22" alt="대표답변 설정"></a>
	{/if}
</script>
<script type="text/javascript" src="https://ssl.pstatic.net/static.kin/static/pc/20210209151259/js/min/jindo_component.all.js"></script>
<script type="text/javascript" src="https://ssl.pstatic.net/static.kin/static/pc/20210209151259/js/min/nhn.Kin.Userinfo.NameCardProfile.js"></script>
	...
	<div class="footer_wrap">
		<div class="footer">
			...
			<div class="footer_menu">
				<a href="http://www.naver.com/rules/service.html"  target="_blank" class="_nclicks:fot.agreement">네이버 이용약관</a>
				<span class="f_bar">|</span>
				<a href="/common/guide.nhn?query=p1"  target="_blank" class="_nclicks:fot.policy">지식iN 서비스 운영정책</a>
				<span class="f_bar">|</span>
				<a href="http://www.naver.com/rules/privacy.html"  target="_blank" class="_nclicks:fot.privacy"><strong>개인정보처리방침</strong></a>
				<span class="f_bar">|</span>
				<a href="http://inoti.naver.com/inoti/main.nhn"  target="_blank" class="_nclicks:fot.claim">게시중단요청서비스</a>
				<span class="f_bar">|</span>
				<a href="https://help.naver.com/support/service/main.nhn?serviceNo=1003" target="_blank" class="_nclicks:fot.help">지식iN 고객센터</a>
			</div>
			<p class="copyright"><a href="http://www.naver.com" class="footer_logo sp_common" target="_blank">NAVER</a>Copyright © <strong><a href="https://www.navercorp.com" target="_blank" class="logo _nclicks:fot.nhncorp">NAVER Corp.</a></strong> All Rights Reserved.</p>
		</div>
	</div>
