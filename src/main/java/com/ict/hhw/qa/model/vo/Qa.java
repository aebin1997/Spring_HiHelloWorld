...
public class Qa implements java.io.Serializable{
	...
	public Qa(int qa_id, String qa_title, String qa_writer, String qa_content, String qa_origin_file_name,
	...
	public String toString() {
		return "Qa [qa_id=" + qa_id + ", qa_title=" + qa_title + ", qa_writer=" + qa_writer + ", qa_content="
				+ qa_content + ", qa_origin_file_name=" + qa_origin_file_name + ", qa_rename_file_name="
				+ qa_rename_file_name + ", qa_readcount=" + qa_readcount + ", qa_create_date=" + qa_create_date
				+ ", qa_modify_date=" + qa_modify_date + ", qa_status=" + qa_status + "]";
	}
