...
public class KakaoController {
	private final static String K_CLIENT_ID = "f2781b420e1c6c14bc80850b31acddfc";
    private final static String K_REDIRECT_URI = "http://localhost:8888/hhw/kakaoLogin.do";
    ...
    public static JsonNode getKakaoUserInfo(String autorize_code) {
      ...
      String CLIENT_ID = "f2781b420e1c6c14bc80850b31acddfc"; // REST API KEY
      String REDIRECT_URI = "http://localhost:8888/hhw/kakaoLogin.do"; // 리다이렉트 URI
